...
namespace UnitTesting
{
    ...
    public:
        ...
        TEST_METHOD(TestValidity_SuchThat_CallsStar_ProcName_Procedure_Valid)
        {
            ...
            SuchThatHandler stHandler = SuchThatHandler(&qt);
            Assert::IsTrue(stHandler.isValidSuchThat(str));
            SuchThatClause expected = UtilitySelection::makeSuchThatClause(CALLSSTAR, IDENT_WITHOUTQUOTES, "\"First\"", PROCEDURE, "q");
            SuchThatClause actual = UtilitySelection::getFirstSuchThatClauseFromTree(qt);
            Assert::IsTrue(UtilitySelection::isSameSuchThatClauseContent(expected, actual));
        }
        ...
        TEST_METHOD(TestValidity_SuchThat_CallsStar_Procedure_ProcName_Valid)
        {
            ...
            SuchThatHandler stHandler = SuchThatHandler(&qt);
            Assert::IsTrue(stHandler.isValidSuchThat(str));
            SuchThatClause expected = UtilitySelection::makeSuchThatClause(CALLSSTAR, PROCEDURE, "p", IDENT_WITHOUTQUOTES, "\"Second\"");
            SuchThatClause actual = UtilitySelection::getFirstSuchThatClauseFromTree(qt);
            Assert::IsTrue(UtilitySelection::isSameSuchThatClauseContent(expected, actual));
        }
        ...
        TEST_METHOD(TestValidity_SuchThat_CallsStar_ProcName_ProcName_Valid)
        {
            ...
            SuchThatHandler stHandler = SuchThatHandler(&qt);
            Assert::IsTrue(stHandler.isValidSuchThat(str));
            SuchThatClause expected = UtilitySelection::makeSuchThatClause(CALLSSTAR, IDENT_WITHOUTQUOTES, "\"First\"", IDENT_WITHOUTQUOTES, "\"Second\"");
            SuchThatClause actual = UtilitySelection::getFirstSuchThatClauseFromTree(qt);
            Assert::IsTrue(UtilitySelection::isSameSuchThatClauseContent(expected, actual));
        }
        ...
        TEST_METHOD(TestValidity_SuchThat_CallsStar_ProcName_Underscore_Valid)
        {
            ...
            SuchThatHandler stHandler = SuchThatHandler(&qt);
            Assert::IsTrue(stHandler.isValidSuchThat(str));
            SuchThatClause expected = UtilitySelection::makeSuchThatClause(CALLSSTAR, IDENT_WITHOUTQUOTES, "\"First\"", UNDERSCORE, "_");
            SuchThatClause actual = UtilitySelection::getFirstSuchThatClauseFromTree(qt);
            Assert::IsTrue(UtilitySelection::isSameSuchThatClauseContent(expected, actual));
        }
        ...
        TEST_METHOD(TestValidity_SuchThat_CallsStar_Underscore_ProcName_Valid)
        {
            ...
            SuchThatHandler stHandler = SuchThatHandler(&qt);
            Assert::IsTrue(stHandler.isValidSuchThat(str));
            SuchThatClause expected = UtilitySelection::makeSuchThatClause(CALLSSTAR, UNDERSCORE, "_", IDENT_WITHOUTQUOTES, "\"Second\"");
            SuchThatClause actual = UtilitySelection::getFirstSuchThatClauseFromTree(qt);
            Assert::IsTrue(UtilitySelection::isSameSuchThatClauseContent(expected, actual));
        }
