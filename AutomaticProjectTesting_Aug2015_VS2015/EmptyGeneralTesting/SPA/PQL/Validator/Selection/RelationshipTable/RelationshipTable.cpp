#include "RelationshipTable.h"
 ...
 ARGUMENT_TYPE_RULES rule1 = { STMT, ASSIGN,WHILE,IF,PROG_LINE,CALL,PROCEDURE,IDENT_WITHOUTQUOTES,INTEGER};
 ARGUMENT_TYPE_RULES rule2 = { VARIABLE, IDENT_WITHOUTQUOTES, UNDERSCORE};
 ...
 ARGUMENT_TYPE_RULES rule5 = { PROCEDURE, IDENT_WITHOUTQUOTES, UNDERSCORE };
 ARGUMENT_TYPE_RULES rule6 = { ASSIGN, STMT, PROG_LINE, INTEGER, UNDERSCORE };
 ARGUMENT_TYPE_RULES rule7 = { STMT, ASSIGN,WHILE,IF,PROG_LINE,CALL,PROCEDURE,IDENT_WITHOUTQUOTES,INTEGER };
 ARGUMENT_TYPE_RULES rule_arg1_for_pattern = { ASSIGN, WHILE };
 ARGUMENT_TYPE_RULES rule_arg2_for_pattern = { VARIABLE, IDENT_WITHOUTQUOTES, UNDERSCORE };
 ARGUMENT_TYPE_RULES rule_arg3_for_pattern = { EXPRESSION_SPEC,UNDERSCORE };
